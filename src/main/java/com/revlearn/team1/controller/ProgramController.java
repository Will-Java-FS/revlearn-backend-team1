...
public class ProgramController {
    ...
    @Operation(summary = "Get Program Students", description = AccessLevelDesc.INSTITUTION + "Returns all students associated with a program.", tags = {"program"})
    public List<UserResDTO> getProgramStudents(@PathVariable Long programId) {
        return programService.getProgramStudents(programId);
    }

    @PostMapping
    @Operation(summary = "Create a Program", description = AccessLevelDesc.INSTITUTION, tags = {"program"})
    ...
    @Operation(summary = "Update a Program", description = AccessLevelDesc.INSTITUTION, tags = {"program"})
    ...
    @Operation(summary = "Delete a Program", description = AccessLevelDesc.INSTITUTION, tags = {"program"})
    ...
    @Operation(summary = "Add a Course to a Program", description = AccessLevelDesc.INSTITUTION, tags = {"program"})
    ...
    @Operation(summary = "Remove a Course from a Program", description = AccessLevelDesc.INSTITUTION, tags = {"program"})
